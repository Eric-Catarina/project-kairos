...
/// </summary>
public class PlayerVisualCaio : MonoBehaviour
{
    [Header("Referências")]
    [Tooltip("Referência ao script de movimento para se inscrever nos eventos.")]
    [SerializeField] private PlayerMovimentCaio playerMovementController;
    ...
    private void OnEnable()
    {
        ...
        {
            Debug.LogError("PlayerMovimentCaio não está atribuído no PlayerVisualsController.");
            return;
        }
